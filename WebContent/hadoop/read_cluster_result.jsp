...
<head>
	<%=basePath %>
    <meta charset="UTF-8">
    <title>读取聚类结果文件</title>
</head>
<body>
<br>
    <p class="intro">读取聚类结果文件内容.</p>
    ...
    <br>
	 <div id="fileContent" class="" title="聚类结果为" >
	 	<p class="intro">聚类结果为：</p>
       <pre id="pId" ></pre>
    </div>
    <script>
        function submitForm(){
        	var win;
            $('#ffreadcenter').form({
            	url:"hadoop_action/hadoop_readClusterResult.action",
